...
| `npm run proof` | 497 checks on the application |
| `npm run proof:db` | Installs the schema into a throwaway Postgres: 308 checks, then 17 more on re-running and recovering the install |
